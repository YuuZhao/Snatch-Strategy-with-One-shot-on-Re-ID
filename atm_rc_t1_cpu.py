...
def main(args):
    ...
    for step in range(total_step+1):
        ...
        print("key parameters contain mv_num:{} len(l_data):{},len(u_data):{}".format(mv_num,len(l_data),len(u_data)))
        ...
        elif step ==0 and args.is_baseline:
