...
def main(args):
    ...
    # 输出该轮训练关键的提示信息
    print("{} training begin with dataset:{},batch_size:{},epoch:{},step_size:{},max_frames:{},num_train_tagper:{}".format(args.exp_name,args.dataset,args.batch_size,args.epoch,args.step_size,args.max_frames,args.num_train_tagper))
    ...
    select_num = args.num_train_tagper # 用于训练tagper的数量
    selected_idx = eug.select_top_data(pred_score,min(select_num,len(u_data)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name',type=str,default="atm_ero02")
    ...
    '''run order
    python3.6 atm_ero02.py --exp_order 0 --num_train_tagper 100  
    python3.6 atm_ero02.py --exp_order 1 --num_train_tagper 200  
    python3.6 atm_ero02.py --exp_order 2 --num_train_tagper 400  
    python3.6 atm_ero02.py --exp_order 3 --num_train_tagper 800  
