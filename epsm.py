...
def main(args):
    ...
    # 总的训练step数的计算
    total_step = 11   # 这里应该取上限或者 +2  多一轮进行one-shot训练的  # EUG base 采样策略
    # total_step = math.ceil((2 * NN * args.step_s + args.yita + len(u_data)) / (args.yita + NN + len(l_data))) + 2 # big start 策略

    # 输出该轮训练关键的提示信息
    print("{} training begin with dataset:{},batch_size:{},epoch:{},step_size:{},max_frames:{},total_step:{},EF:{},q:{},amp:{}".format(args.exp_name,args.dataset,args.batch_size,args.epoch,args.step_size,args.max_frames,total_step+1,args.EF,args.q,args.amp))
    ...
    if args.resume:
        step = resume_step
        nums_to_select = y2(len(u_data),step-1,args.amp,args.bb)
    step_size = []
    ...
    while(not isout):
        ...
        print("key parameters contain EF:{},q:{},amp:{}. Nums_been_selected:{}".format(args.EF,args.q,args.amp,nums_to_select))
        ...
        new_nums_to_select = y2(len(u_data),step,args.amp,args.bb)
        print("now, we tend to select {} pseudo-label samples.".format(new_nums_to_select))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name',type=str,default="epsm3")
    ...
    parser.add_argument('--sp', type=int, default=5)
    ...
    '''
    python3.6 epsm.py --exp_order 0 --EF 10 --q 1 --amp 1
    python3.6 epsm.py --exp_order 1 --EF 14 --q 0.85 --amp 0.9
    python3.6 epsm.py --exp_order 2 --EF 18 --q 0.74 --amp 0.8
    python3.6 epsm.py --exp_order 3 --EF 25 --q 0.6 --amp 0.7
    python3.6 epsm.py --exp_order 4 --EF 35 --q 0.45 --amp 0.6
    
    
    # python3.6 epsm.py --exp_order 0 --EF 10 --q 1 --amp 1
    python3.6 epsm.py --exp_order 1  --amp 0.9  --bb 100
    python3.6 epsm.py --exp_order 2  --amp 0.8  --bb 200
    python3.6 epsm.py --exp_order 3  --amp 0.7  --bb 300
    python3.6 epsm.py --exp_order 4  --amp 0.6  --bb 420
