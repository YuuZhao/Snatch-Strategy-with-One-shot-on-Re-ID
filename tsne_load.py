...
def main(args):
    ...
    print('Saving fts...')
    np.save('tsne/mars/Dissimilarity_step_0_fts.npy',fts)
    print('Saving lbs...')
    np.save('tsne/mars/Dissimilarity_step_0_lbs.npy',lbs)
    print('Saving cams...')
    np.save('tsne/mars/Dissimilarity_step_0_cams.npy',cams)
    print('Done.')
