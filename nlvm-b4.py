...
def main(args):
    ...
    # 输出该轮训练关键的提示信息
    print("{} training begin with dataset:{},batch_size:{},epoch:{},step_size:{},max_frames:{},total_step:{},EF:{},q:{},percent_vari:{} stop_vari_step:{}".format(args.exp_name,args.dataset,args.batch_size,args.epoch,args.step_size,args.max_frames,total_step+1,args.EF,args.q,args.percent_vari,args.stop_vari_step))
    ...
    while(not isout):
        ...
        print("key parameters contain EF:{},q:{},percent_vari:{}.stop_vari_step:{} Nums_been_selected:{}".format(args.EF,args.q,args.percent_vari,args.stop_vari_step,nums_to_select))
        ...
        if step < args.stop_vari_step:
            real_percent_vari = min((1-args.percent_vari)*(step+1)/(args.stop_vari_step+1)+args.percent_vari,1)
