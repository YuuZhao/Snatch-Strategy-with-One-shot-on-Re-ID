...
def main(args):
    ...
    # 输出该轮训练关键的提示信息
    print(
        "{} training begin with dataset:{},batch_size:{},epoch:{},step_size:{},max_frames:{},total_step:{},EF:{},q:{},percent_vari:{} stop_vari_step:{}".format(
            args.exp_name, args.dataset, args.batch_size, args.epoch, args.step_size, args.max_frames, total_step + 1,
            args.EF, args.q, args.percent_vari, args.stop_vari_step))
    ...
    while (not isout):
        print("{} training begin with dataset:{},batch_size:{},epoch:{},step:{}/{} saved to {}.".format(args.exp_name,
                                                                                                        ...
                                                                                                        save_path))
        print(
            "key parameters contain EF:{},q:{},percent_vari:{}.stop_vari_step:{} Nums_been_selected:{}".format(args.EF,
                                                                                                               args.q,
                                                                                                               args.percent_vari,
                                                                                                               args.stop_vari_step,
                                                                                                               nums_to_select))
...
if __name__ == '__main__':
    ...
    '''
    python3.6 nlvm-b4.py --exp_order 0 --percent_vari 1 --stop_vari_step 0  #this is baseline.
    python3.6 nlvm-b4.py --exp_order 1 --percent_vari 0.9 --stop_vari_step 5  
    python3.6 nlvm-b4.py --exp_order 2 --percent_vari 0.8 --stop_vari_step 5  
    python3.6 nlvm-b4.py --exp_order 3 --percent_vari 0.7 --stop_vari_step 5  
